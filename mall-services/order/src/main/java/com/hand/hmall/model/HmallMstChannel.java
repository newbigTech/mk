...
/**
 * @author 梅新养
 * @name:HmallMstChannel
 * @Description:HMALL_MST_CHANNEL 对应的实体类
 * @version 1.0
 * @date 2017/5/24 14:39
 */
@Entity
@Table(name = "HMALL_MST_CHANNEL")
public class HmallMstChannel {
    /**
     * 主键
     */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select HMALL_MST_CHANNEL_S.nextval from dual")
