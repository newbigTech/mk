...
public class ConsignmentBk {
    /**
     * 主键
     */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select HMALL_OM_CONSIGNMENT_BK_S.nextval from dual")
    ...
    * */
    ...
    /**
     * 版本号
     * @param objectVersionNumber 客服已审核
     */
