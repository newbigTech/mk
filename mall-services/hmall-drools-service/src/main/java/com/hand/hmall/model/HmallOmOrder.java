 ...
 * @author 梅新养
 * @name:HmallOmOrder
 * @Description:HMALL_OM_ORDER 对应的实体类
 * @version 1.0
 * @date 2017/5/24 14:39
 */
@Entity
@Table(name = "HMALL_OM_ORDER")
public class HmallOmOrder {
    /**
     * 主键
     */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select HMALL_OM_ORDER_S.nextval from dual")
    ...
    @Transient
    private List<HmallOmOrderEntry> entryList;

    @Transient
    private List<HmallOmPaymentInfo> payList;

    @Transient
    private List<HmallOmPromotionRule> orderPromotionList;

    @Transient
    private List<HmallOmCouponRule> orderCouponList;
    ...
    public List<HmallOmOrderEntry> getEntryList() {
        return entryList;
    }

    public void setEntryList(List<HmallOmOrderEntry> entryList) {
        this.entryList = entryList;
    }

    public List<HmallOmPaymentInfo> getPayList() {
        return payList;
    }

    public void setPayList(List<HmallOmPaymentInfo> payList) {
        this.payList = payList;
    }

    public List<HmallOmPromotionRule> getOrderPromotionList() {
        return orderPromotionList;
    }

    public void setOrderPromotionList(List<HmallOmPromotionRule> orderPromotionList) {
        this.orderPromotionList = orderPromotionList;
    }
    public List<HmallOmCouponRule> getOrderCouponList() {
        return orderCouponList;
    }

    public void setOrderCouponList(List<HmallOmCouponRule> orderCouponList) {
    ...
    public void setIsIo(String isIo) {
        this.isIo = isIo == null ? null : isIo.trim();
    }
    ...
    public void setSyncZmall(String syncZmall) {
        this.syncZmall = syncZmall == null ? null : syncZmall.trim();
    }
