 ...
 * @Description:表HMALL_MST_CUSTOMERCHECK对应实体类
 * @date 2017/6/1 16:11
 */
@Entity
@Table(name = "HMALL_MST_CUSTOMERCHECK")
public class HmallMstCustomerCheck {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select HMALL_MST_CUSTOMERCHECK_S.nextval from dual")
    /**
     * 主键
     */
