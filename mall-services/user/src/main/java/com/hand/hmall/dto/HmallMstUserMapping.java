...
/**
 * @author 阳赳
 * @name:HmallMstUserMapping
 * @Description:表HMALL_MST_USER_MAPPING对应实体类
 * @date 2017/6/1 16:11
 */
@Entity
@Table(name = "HMALL_MST_USER_MAPPING")
public class HmallMstUserMapping {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select HMALL_MST_USER_MAPPING_S.nextval from dual")
    /**
     * 主键
     */
