...
public class XmlUtil {
    ...
    //是否增加data标签
    public static XStream getXStreamIncludeUnderline(boolean cdata) {
    ...
    public static Map xml2map(String xmlStr, boolean needRootKey){
        ...
        try {
            ...
            logger.error("XmlUtil-xml2map-DocumentHelper.parseText-fail",e);
        }
    ...
    private static Map xml2mapWithAttr(Element element) {
        ...
        List<Attribute> listWithParams = element.attributes(); // 当前节点的所有属性的list
        for (Attribute attr : listWithParams) {
    ...
    private static Element map2xml(Map<String, Object> map, Element body) {
        ...
        while (entries.hasNext()) {
            ...
            //System.out.println("Key = " + entry.getKey() + ", Value = " + entry.getHpayValue());
        }
        return body;
    }
