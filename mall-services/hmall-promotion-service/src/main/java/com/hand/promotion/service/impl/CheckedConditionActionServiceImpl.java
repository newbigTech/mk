...
import com.hand.promotion.dto.MstBundles;
import com.hand.promotion.dto.MstCategory;
import com.hand.promotion.mapper.HmallMstBundlesMapper;
import com.hand.promotion.pojo.activity.ActionPojo;
import com.hand.promotion.pojo.activity.ConditionPojo;
import com.hand.promotion.service.ICheckedConditionActionService;
...
public class CheckedConditionActionServiceImpl implements ICheckedConditionActionService {
     ...
     */
    @Override
    public void getDetailForAction(ActionPojo actionPojo, Map detail) {
        JSONObject action = JSONObject.parseObject(JSON.toJSONString(actionPojo));
        switch (actionPojo.getDefinitionId()) {
            //订单减X元
            case "o_total_discount":
                String orderReduceFee = getActionValue(action);
                detail.put("orderReduceFee", orderReduceFee);
                detail.put("activityType", actionPojo.getDefinitionId());
                break;
     ...
     */
    @Override
    public void getDetailForCondition(ConditionPojo conditionPojo, Map detail) {
        JSONObject conditionObj = JSONObject.parseObject(JSON.toJSONString(conditionPojo));
