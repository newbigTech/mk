...
public class DateUtil {
	...
	public static String formMillstToDate(String mills,String temp){
		SimpleDateFormat sdf=new SimpleDateFormat(temp);
		return sdf.format(Long.parseLong(mills));
	}

	public static String formMillstToDate(Long mills,String temp){
		SimpleDateFormat sdf=new SimpleDateFormat(temp);
		return sdf.format(mills);
	}

	public static String currentDate(){
		return formMillstToDate(System.currentTimeMillis(),"yyyy-MM-dd HH:mm:ss");
	}
