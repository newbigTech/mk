 ...
 * @author chenzhigang
 * @version 0.1
 * @name AcceptProcessTask
 * @description 退款单工作流，审批通过节点
 * @date 2017/11/10
 */
@Component
public class AcceptProcessTask implements JavaDelegate, IActivitiBean {
    ...
    public void execute(DelegateExecution execution) {
        ...
        ar.setStatus("APPROVE");
        mapper.updateByPrimaryKey(ar);
    }

    @Override
    public String getBeanName() {
        return "asRefundAccept";
    }
}
