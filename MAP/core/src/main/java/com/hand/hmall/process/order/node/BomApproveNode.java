 ...
 * @version 0.1
 * @name BomApproveNode
 * @description 工艺审核信息推送
 * @date 2017/7/29 14:29
 */
public class BomApproveNode extends AbstractOrderNode {

    private static final String NODE_NAME = "工艺审核信息推送";
    ...
    public NodeResponse<Order> execute(Order order) {
        ...
        try {
            iOrderProcessService.bomApprove(order);
