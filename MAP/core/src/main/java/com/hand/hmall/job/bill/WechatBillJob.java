 ...
 */
@RemoteJob
public class WechatBillJob extends AbstractJob implements RemoteJobTask {
        ...
        try {
            ...
            for (int i = maxDate + 1; i > 0; i--) {
                ...
                if (null != iOmAccountsRecordService.getOmAccountsRecord(condition)) {
                    ...
                    responseData = accountsService.WechatBillAnalysisService(preDate);
