 ...
 */
@RemoteJob
public class AlipayBillJob extends AbstractJob implements RemoteJobTask {
    ...
    public void safeExecute(JobExecutionContext jobExecutionContext) throws Exception {
        ...
        logManager.setProgramDescription("支付宝账单解析");
        ...
        try {
            ...
            for (int i = maxDate + 1; i > 0; i--) {
                ...
                if (null != iOmAccountsRecordService.getOmAccountsRecord(condition)) {
                    ...
                    responseData = accountsService.AlipayBillAnalysisService(preDate);
