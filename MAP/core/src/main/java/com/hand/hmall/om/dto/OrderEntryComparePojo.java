...
public class OrderEntryComparePojo extends BaseDTO {
    @Id
    @GeneratedValue
    ...
    @ExcelVOAttribute(name = "V码", column = "A", isExport = true)
    ...
    @ExcelVOAttribute(name = "前台产品外形尺寸", column = "F", isExport = true)
    private String productSize;
    @ExcelVOAttribute(name = "前台包装尺寸", column = "G", isExport = true)
    ...
    @ExcelVOAttribute(name = "商品编码", column = "B", isExport = true)
    @Transient
    private String productCode;
    @ExcelVOAttribute(name = "商品名称", column = "C", isExport = true)
    @Transient
    private String productName;
    @ExcelVOAttribute(name = "中台销售价", column = "I", isExport = true)
    @Transient
    private Double platformSalesPrice;
    @ExcelVOAttribute(name = "材质（价签）", column = "D", isExport = true)
    @Transient
    private String texture;
    @ExcelVOAttribute(name = "材质（说明书）", column = "E", isExport = true)
    @Transient
    private String textureSpecification;
    @ExcelVOAttribute(name = "中台产品外形尺寸", column = "H", isExport = true)
    @Transient
    private String platformProductSize;
    @ExcelVOAttribute(name = "中台包装尺寸", column = "I", isExport = true)
    @Transient
    ...
    public boolean equals(Object obj) {
        if (obj instanceof OrderEntryComparePojo) {
            OrderEntryComparePojo orderEntry = (OrderEntryComparePojo) obj;
